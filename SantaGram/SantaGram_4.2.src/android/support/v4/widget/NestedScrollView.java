  ...
  implements ab, w, y
{
  ...
  private void g()
  {
    if (af.a(this) != 2)
    {
      if (this.d == null)
      {
        ...
        this.d = new h(localContext);
        this.e = new h(localContext);
      }
      return;
    }
    this.d = null;
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (i1 != -1)
      {
        ...
        {
          i1 = (int)s.d(paramMotionEvent, i2);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (this.j)
    {
      ...
      if (i2 < 0)
      {
        this.d.a(i1 / getHeight(), s.c(paramMotionEvent, i3) / getWidth());
        if (!this.e.a()) {
          this.e.b();
        }
      }
      while ((this.d != null) && ((!this.d.a()) || (!this.e.a())))
      {
        ...
        if (i2 > i4)
        {
          this.e.a(i1 / getHeight(), 1.0F - s.c(paramMotionEvent, i3) / getWidth());
          if (!this.d.a()) {
            this.d.b();
          }
        }
      ...
      if (this.j)
      {
        ...
        i1 = (int)ad.b(paramMotionEvent, this.q);
      ...
      break;
      a(paramMotionEvent);
      this.f = ((int)s.d(paramMotionEvent, s.a(paramMotionEvent, this.q)));
      break;
    }
  }
  ...
  static class a
    extends android.support.v4.j.a
  {
    ...
    public void d(View paramView, AccessibilityEvent paramAccessibilityEvent)
    {
      ...
      paramAccessibilityEvent = android.support.v4.j.a.a.a(paramAccessibilityEvent);
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/android/support/v4/widget/NestedScrollView.class
