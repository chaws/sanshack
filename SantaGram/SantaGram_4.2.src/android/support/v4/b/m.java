...
{
  private static final android.support.v4.i.i<String, Class<?>> Z = new android.support.v4.i.i();
  ...
  public LayoutInflater b(Bundle paramBundle)
  {
    ...
    d();
    android.support.v4.j.i.a(paramBundle, this.u.s());
    return paramBundle;
  }
  ...
  void y()
  {
    ...
    this.u.a(this.t, new o()
    {
      public View a(int paramAnonymousInt)
      {
        ...
        return m.this.I.findViewById(paramAnonymousInt);
      }
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/android/support/v4/b/m.class
