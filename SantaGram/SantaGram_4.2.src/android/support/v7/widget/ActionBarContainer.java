  ...
  extends FrameLayout
{
  ...
  public ActionBarContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      this.a = paramContext.getDrawable(a.k.ActionBar_background);
      this.b = paramContext.getDrawable(a.k.ActionBar_backgroundStacked);
      this.j = paramContext.getDimensionPixelSize(a.k.ActionBar_height, -1);
      if (getId() == a.f.split_action_bar)
      {
        this.d = true;
        this.c = paramContext.getDrawable(a.k.ActionBar_backgroundSplit);
      }
  ...
  public void setTabContainer(at paramat)
  {
    if (this.g != null) {
      removeView(this.g);
    }
    ...
    {
      addView(paramat);
      ViewGroup.LayoutParams localLayoutParams = paramat.getLayoutParams();
      localLayoutParams.width = -1;
      localLayoutParams.height = -2;
      paramat.setAllowCollapse(false);
    }
  }
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/android/support/v7/widget/ActionBarContainer.class
