  ...
  extends LinearLayout
{
  ...
  public ButtonBarLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.a = paramContext.getBoolean(a.k.ButtonBarLayout_allowStacking, false);
    ...
    if ((!a()) && (View.MeasureSpec.getMode(paramInt1) == 1073741824))
    {
      ...
      if (this.a)
      {
        ...
        if (!a())
        {
          ...
          j = m;
          if ((af.i(this) & 0xFF000000) == 16777216) {
            j = 1;
          }
        }
      }
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/android/support/v7/widget/ButtonBarLayout.class
