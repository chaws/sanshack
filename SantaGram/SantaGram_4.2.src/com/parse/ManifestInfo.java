...
class ManifestInfo
{
  ...
  private static ManifestCheckResult gcmSupportLevel()
  {
    ...
    if (!hasRequestedPermissions(localContext, new String[] { "android.permission.INTERNET", "android.permission.ACCESS_NETWORK_STATE", "android.permission.WAKE_LOCK", "com.google.android.c2dm.permission.RECEIVE", localContext.getPackageName() + ".permission.C2D_MESSAGE" })) {
      return ManifestCheckResult.MISSING_REQUIRED_DECLARATIONS;
    }
  ...
  private static boolean hasRequestedPermissions(Context paramContext, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      boolean bool = Arrays.asList(paramContext.requestedPermissions).containsAll(Arrays.asList(paramVarArgs));
      return bool;
    }
    catch (PackageManager.NameNotFoundException paramContext)
    {
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/com/parse/ManifestInfo.class
