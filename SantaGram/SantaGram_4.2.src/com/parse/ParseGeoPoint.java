...
public class ParseGeoPoint
{
  ...
  public static j<ParseGeoPoint> getCurrentLocationInBackground(long paramLong)
  {
    Criteria localCriteria = new Criteria();
    localCriteria.setAccuracy(0);
    localCriteria.setPowerRequirement(0);
    LocationNotifier.getCurrentLocationAsync(Parse.getApplicationContext(), paramLong, localCriteria).c(new h()
    {
      public ParseGeoPoint then(j<Location> paramAnonymousj)
      {
        paramAnonymousj = (Location)paramAnonymousj.f();
        return new ParseGeoPoint(paramAnonymousj.getLatitude(), paramAnonymousj.getLongitude());
      }
    });
  }
  
  public static j<ParseGeoPoint> getCurrentLocationInBackground(long paramLong, Criteria paramCriteria)
  {
    LocationNotifier.getCurrentLocationAsync(Parse.getApplicationContext(), paramLong, paramCriteria).c(new h()
    {
      public ParseGeoPoint then(j<Location> paramAnonymousj)
      {
        paramAnonymousj = (Location)paramAnonymousj.f();
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/com/parse/ParseGeoPoint.class
