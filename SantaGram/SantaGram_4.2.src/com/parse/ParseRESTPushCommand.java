  ...
  extends ParseRESTCommand
{
  ...
  public ParseRESTPushCommand(String paramString1, b.b paramb, JSONObject paramJSONObject, String paramString2)
  {
  ...
  public static ParseRESTPushCommand sendPushCommand(ParseQuery.State<ParseInstallation> paramState, Set<String> paramSet, String paramString1, Long paramLong1, Long paramLong2, JSONObject paramJSONObject, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        return new ParseRESTPushCommand("push", b.b.b, localJSONObject, paramString2);
      }
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/com/parse/ParseRESTPushCommand.class
