...
class ParseCorePlugins
{
  ...
  public ParseObjectSubclassingController getSubclassingController()
  {
    ...
    {
      ParseObjectSubclassingController localParseObjectSubclassingController = new ParseObjectSubclassingController();
      this.subclassingController.compareAndSet(null, localParseObjectSubclassingController);
    }
  ...
  public void registerSubclassingController(ParseObjectSubclassingController paramParseObjectSubclassingController)
  {
    if (!this.subclassingController.compareAndSet(null, paramParseObjectSubclassingController)) {
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/com/parse/ParseCorePlugins.class
