  ...
  extends ParseRESTCommand
{
  ...
  public ParseRESTAnalyticsCommand(String paramString1, b.b paramb, JSONObject paramJSONObject, String paramString2)
  {
  ...
  static ParseRESTAnalyticsCommand trackEventCommand(String paramString1, String paramString2, Map<String, String> paramMap, String paramString3)
  {
    ...
    try
    {
      ...
      return new ParseRESTAnalyticsCommand(paramString1, b.b.b, localJSONObject, paramString3);
    }
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/com/parse/ParseRESTAnalyticsCommand.class
