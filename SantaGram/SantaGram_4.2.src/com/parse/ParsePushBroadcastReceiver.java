  ...
  extends BroadcastReceiver
{
  ...
  {
    Object localObject1 = paramIntent.getStringExtra("com.parse.Data");
    if (localObject1 == null) {
    ...
    {
      return;
      PLog.v("com.parse.ParsePushReceiver", "Received push data: " + (String)localObject1);
      try
      {
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/com/parse/ParsePushBroadcastReceiver.class
