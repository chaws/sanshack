...
{
  private ParseRESTQueryCommand(String paramString1, b.b paramb, Map<String, ?> paramMap, String paramString2)
  {
  ...
  public static <T extends ParseObject> ParseRESTQueryCommand countCommand(ParseQuery.State<T> paramState, String paramString)
  {
    ...
    return new ParseRESTQueryCommand(str, b.b.a, paramState, paramString);
  }
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/com/parse/ParseRESTQueryCommand.class
