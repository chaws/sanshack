  ...
  implements ProxyService
{
  ...
  private void handleGcmRegistrationIntent(Intent paramIntent)
  {
    try
    {
      GcmRegistrar.getInstance().handleRegistrationIntentAsync(paramIntent).h();
      return;
    }
...
/* Location:              /home/cdo/tmp/sanshack/SantaGram_4.2-dex2jar.jar!/com/parse/GCMService.class
